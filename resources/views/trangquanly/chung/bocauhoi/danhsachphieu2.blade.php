            ...
            <div class="page-header">
                ...
                <div class="row mt-3">
                    <div class="col-8 p-5 bg-light mx-auto">
                        <h4 class="text-center">PHIẾU KHẢO SÁT SỐ 02</h4>
                        <h3 class="text-center mt-3">CHUYỂN ĐỔI SỐ CỦA DOANH NGHIỆP NHỎ VÀ VỪA</h3>
                        <p class="text-center mt-3">(Jerry Watkins, Nguyen Quang Trung, Mathews Nkhoma, Vo Khanh Thien,
                            Nguyen Le Hoang Long, Centre
                            of Digital Excellence RMIT University Vietnam, 2020)</p>
