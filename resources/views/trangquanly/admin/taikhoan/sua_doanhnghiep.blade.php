                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs nav-tabs-solid nav-tabs-rounded nav-justified">
                            <li class="nav-item"><a class="nav-link active tab-tab1-dn"
                                    ...
                                    nghiệp</a></li>
                            <li class="nav-item"><a class="nav-link tab-tab2-dn" href="#solid-rounded-justified-tab2-dn"
                                    data-toggle="tab">Thông tin đại diện
                                    doanh nghiệp</a></li>
                            <li class="nav-item"><a class="nav-link tab-tab3-dn" href="#solid-rounded-justified-tab3-dn"
                                    data-toggle="tab">Thông tin tài
                                    khoản</a></li>
                        </ul>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="doanhnghiep_tentiengviet"
                                                    required value="{{ $user->getdoanhnghiep->tentiengviet }}">
                                                ...
                                                {{-- <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="loai_sdt"
                                                            ...
                                                            <option @if ($user->getdoanhnghiep->getsdt->loaisdt == 'Văn
                                                                phòng') selected @endif>
                                                                Văn phòng</option>
                                                            <option @if ($user->getdoanhnghiep->getsdt->loaisdt == 'Di
                                                                động') selected @endif>Di
                                                                động</option>
                                                        </select>
                                                        <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-6">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control doanhnghiep_city_1"
                                                            ...
                                                            id="doanhnghiep_city_1" name="doanhnghiep_thanhpho"
                                                            required>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control"
                                                            onclick="this.setAttribute('value', this.value);" onload=""
                                                            value="" id="doanhnghiep_district_1"
                                                            name="doanhnghiep_huyen" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea rows="4" cols="5" class="form-control"
                                                    placeholder="Enter message" name="doanhnghiep_diachi"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea rows="4" cols="5" class="form-control"
                                                    ...
                                                    name="doanhnghiep_mota">{{ $user->getdoanhnghiep->mota }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control"
                                                            onclick="this.setAttribute('value', this.value);" value=""
                                                            id="doanhnghiep_ward_2" name="doanhnghiep_daidien_xa"
                                                            required>
                                                            <option value="">--Chọn phường/xã--</option>
                                                        </select>
                                                        <input type="hidden"
                                            ...
                                            <div class="form-group">
                                                <label>Địa chỉ</label>
                                                <textarea rows="4" cols="5" class="form-control"
                                                    placeholder="Enter message" name="doanhnghiep_daidien_diachi"
                                                    required>{{ $user->getdoanhnghiep->getdaidien->diachi }}</textarea>
                                                <div class="invalid-feedback">
                                                ...
                                                <div class="col-md-5">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="sel1"
                                                            ...
                                                            <option value="">--- Chọn ---</option>
                                                            <option value="Chủ tịch" @if ($user->
                                                                getdoanhnghiep->getdaidien->chucvu == 'Chủ tịch')
                                                                selected @endif>
                                                                Chủ tịch</option>
                                                            <option value="Giám đốc" @if ($user->
                                                                getdoanhnghiep->getdaidien->chucvu == 'Giám đốc')
                                                                selected @endif>
                                                                Giám đốc</option>
                                                            <option value="Quản lý" @if ($user->
                                                                getdoanhnghiep->getdaidien->chucvu == 'Quản lý')
                                                                selected @endif>
                                                                Quản lý</option>
                                                            <option value="Trưởng phòng" @if ($user->
                                                                getdoanhnghiep->getdaidien->chucvu == 'Trưởng phòng')
                                                                selected @endif>
                                                                Trưởng phòng</option>
                                                            <option value="Khác" @if ($user->
                                                                getdoanhnghiep->getdaidien->chucvu == 'Khác') selected
                                                                @endif>
                                                                Khác</option>
                                                        </select>
                                                        <div class="invalid-feedback">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-check form-check-inline rounded border p-2 w-100">
                                                    <input class="form-check-input" type="radio" name="status"
                                                        id="blog_active" value="Active" @if ($user->status == 'Active')
                                                    checked="true" @endif>
                                                    <label class="form-check-label" for="blog_active"> Hoạt động
                                                    </label>
                                                    <span style="width: 30px;"></span>
                                                    <input class="form-check-input" type="radio" name="status"
                                                        id="blog_active_1" value="Inactive" @if ($user->status ==
                                                    'Inactive') checked="true" @endif>
