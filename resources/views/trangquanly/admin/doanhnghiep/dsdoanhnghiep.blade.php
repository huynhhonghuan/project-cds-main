                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="#" class="avatar avatar-sm mr-2" style="width:100px;height:100px">
                                                    <img class="avatar-img" src="{{ asset('assets/backend/img/hoso/'. $value->getuser->image) }}" alt="{{ $value->getuser->image }}">
                                                </a>
                                                @else
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('admin.doanhnghiep.xemdn', $value->user_id) }}" class="btn btn-sm mr-2"><i class="fa-regular fa-eye" style="color:orange;"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
...
<script>
    ...
    window.addEventListener("load", function() {
        try {
            ...
            let table;
            if (loaiSession != null) {
                table = document.getElementById(loaiSession)
