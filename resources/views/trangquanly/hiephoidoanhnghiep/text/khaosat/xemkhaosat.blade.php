            ...
            <div class="bg-light py-4 px-3">
                ...
                <div class="row">
                    <div class="col-12 mt-5">
                        <div class="">
                            <h4 class="text-center text-secondary">Khảo sát ngày
                        ...
                        <div class="col-md-6 col-lg-3 mx-auto">
                            <div class="mx-auto border  border-warning p-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <a href="{{ route('chuyengia.danhgia.phieu1', ['id' => $khaosat->id]) }}"
                        ...
                        <div class="col-md-6 col-lg-3 mx-auto">
                            <div class="mx-auto border  border-info p-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <a href="{{ route('chuyengia.danhgia.phieu2', ['id' => $khaosat->id]) }}"
                                            class="btn"><i class="fa-solid fa-circle-right"
                                                style="font-size: 40px; color: rgb(72, 72, 182);"></i></a>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6 col-lg-3 mx-auto">
                            <div class="mx-auto border border-danger p-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <a href="{{ route('chuyengia.danhgia.phieu3', ['id' => $khaosat->id]) }}"
                                            class="btn"><i class="fa-solid fa-circle-right"
                                                style="font-size: 40px; color: rgb(72, 72, 182);"></i></a>
                                    </div>
                                </div>
