...
<div class="header">
    <div class="header-left">
        <a href="{{ route('hiephoidoanhnghiep.home') }}" class="logo"> <img src="{{ env('APP_URL') }}/assets/backend/img/vaitro/teamwork.png"
                width="50" height="70" alt="logo"> <span class="logoclass">Hiệp Hội</span> </a>
        <a href="{{ route('hiephoidoanhnghiep.home') }}" class="logo logo-small"> <img
                src="{{ env('APP_URL') }}/assets/backend/img/vaitro/teamwork.png" alt="Logo" width="30" height="30">
        </a>
    </div>
    ...
    <ul class="nav user-menu">
        ...
        <li class="nav-item dropdown has-arrow">
            <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown"> <span class="user-img"><img
                        class="rounded-circle" src="{{ env('APP_URL') }}/assets/img/profiles/avatar-01.jpg') }}" width="31"
                        alt="Soeng Souy"></span> </a>
            <div class="dropdown-menu">
                <div class="user-header">
                    <div class="avatar avatar-sm"> <img src="{{ env('APP_URL') }}/assets/img/profiles/avatar-01.jpg') }}"
