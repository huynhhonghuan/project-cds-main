                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control"
                                                                    onclick="this.setAttribute('value', this.value);"
                                                                    value="" id="chuyengia_ward_1"
                                                                    name="chuyengia_xa" required>
                                                                    <option value="">--Chọn phường/xã--</option>
                                                                </select>
                                                                <input type="hidden"
                                                                    value="{{ $user->getchuyengia->xa }}"
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Ảnh mặt trước CCCD</label>
                                                        <input type="file" class="form-control"
                                                            name="chuyengia_cccd_img_mattruoc" required>
                                                        <div class="invalid-feedback">
                                                            Chọn hình ảnh CCCD mặt trước!
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Ảnh mặt sau CCCD</label>
                                                        <input type="file" class="form-control"
                                                            name="chuyengia_cccd_img_matsau" required>
                                                        <div class="invalid-feedback">
                                                            Chọn hình ảnh CCCD mặt sau!
                                                        </div>
                                                    </div>
                    ...
                    <div id="table4" class="col-md-8 mx-auto">
                        <div class="col d-flex">
                            <div class="card rounded-top rounded-bottom w-100 border border-success-subtle">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('admin.taikhoan.them_loai', ['loai' => 'ctv']) }}"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="password"
                                                    class="form-control @error('password') is-invalid @enderror"
                                                    value="" id="password" name="password" required />
                                                <span class="input-group-addon">
                                                    <i class="fa fa-eye" id="toggle-password"></i>
                                                </span>
                                                @error('password')
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-5 custom-file mx-3">
                                                <input type="file"
                                                ...
                                                <label class="custom-file-label" for="congtacvien_img">Chọn file hình
                                                    ảnh</label>
                                        ...
                                        <div class="text-right">
                                            <button type="submit" class="btn btn-primary">Sửa đổi cộng tác viên</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
