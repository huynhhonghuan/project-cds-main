...
<div class="sidebar" id="sidebar">
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                <li class="active"> <a href="index.html"><i class="fas fa-tachometer-alt"></i> <span>Bảng điều
                            khiển</span></a> </li>
                ...
                <li> <a href="pricing.html"><i class="fa-regular fa-square-check"></i> <span>Danh sách đánh
                            giá</span></a> </li>
                ...
                <li> <a href="{{route('chuyengia.doanhnghiep.danhsach')}}"><i class="fa-regular fa-building"></i> <span>Danh sách doanh
                            nghiệp</span></a> </li>
