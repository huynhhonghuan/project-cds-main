        ...
        <div class="content container" style="padding:0;margin-bottom: 50px; border: 1px solid #999;">
            <div class="row" style="background: linear-gradient( -35deg, #014872, #A0CACF, #41c6ff); padding : 16px 32px;margin: 0">
                <div class=" d-flex align-items-center">
                    <div class="me-2">
                        <img style="width:60px;height:60px;border-radius:50%;border: 2px solid #ff0000;object-fit:cover" src="{{ asset('assets/backend/img/hoso/'.$laydoanhnghiep->getDoanhNghiepUser->image) }}" alt="">
                    </div>
                    <div class="" style="margin-left: 8px">
                        <div style="margin: 0;font-size:20px;font-weight:600;color:#000000;text-transform: uppercase;padding-left: 12px">{{$laydoanhnghiep->getDoanhNghiep->tentiengviet}}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="container" style="position:fixed;bottom:5%;margin-left:32px">
                <form action="{{ route('chuyengia.themtinnhan') }}"  style="display:flex" method="post"> @csrf
