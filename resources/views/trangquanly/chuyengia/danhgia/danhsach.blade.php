                                    ...
                                    <tbody>
                                        @foreach ($danhsach as $value)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{ route('chuyengia.danhgia.xemkhaosat', ['id' => $value->id]) }}"
                                                        class="btn btn-sm mr-2"><i class="fa-regular fa-eye"
                                                            style="color:orange;"></i></a>
                                                </td>
                                                <td class="text-center">
                                                    <a href="{{ route('chuyengia.danhgia.xemchienluoc', ['id' => $value->id]) }}"
                                                        class="btn btn-sm mr-2"><i class="fa-regular fa-eye"
                                                            style="color:orange;"></i></a>
                                                </td>
                                                <td class="text-center">
                                                    <a href="{{ route('chuyengia.danhgia.xemdanhgia', ['id' => $value->id]) }}"
                                                        class="btn btn-sm mr-2"><i class="fa-regular fa-eye"
                                                            style="color:orange;"></i></a>
                                                </td>
                                                <td class="text-center">
