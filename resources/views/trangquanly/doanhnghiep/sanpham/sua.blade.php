                    ...
                    <div class="row formtype">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('tensanpham') is-invalid @enderror" name="tensanpham" value="{{$sanpham->tensanpham}}">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label>Giá Sản Phẩm</label>
                                <input type="number" class="form-control @error('gia') is-invalid @enderror" name="gia" value="{{$sanpham->gia}}">
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <textarea type="text" rows="5" class="form-control @error('mota') is-invalid @enderror" name="mota">{{$sanpham->mota}}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
