    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="submenu"> <a href="#"><i class="fa-solid fa-list-ol"></i> <span> Khảo sát </span> <span class="menu-arrow"></span></a>
                ...
                <li class="submenu"> <a href="#"><i class="fa-regular fa-circle-question"></i> <span> Bộ câu hỏi </span> <span class="menu-arrow"></span></a>
                    <ul class="submenu_class" style="display: none;">
                ...
                <li class="submenu"> <a href="#"><i class="fa-solid fa-chart-line"></i> <span> Chiến lược </span> <span class="menu-arrow"></span></a>
                    <ul class="submenu_class" style="display: none;">
                ...
                <li class="submenu"> <a href="#"><i class="fa-regular fa-comments"></i> <span> Đánh giá và góp ý </span> <span class="menu-arrow"></span></a>
                    <ul class="submenu_class" style="display: none;">
