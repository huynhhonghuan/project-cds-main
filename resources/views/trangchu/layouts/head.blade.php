{{--nhúng tất cả các header--}}
 ...
 <link rel="shortcut icon" type="image/x-icon" href="{{ URL::to('public/assets/frontend/img/logo/logo-1.png') }}">

 <!--Bootstrap CSS file nhớ cài npm i bootstrap@5.3.1 phiên bản tùy theo lấy file json-->
 <link rel="stylesheet" href="{{ URL::to('public/assets/bootstrap-5.0.2/dist/css/bootstrap.min.css') }}">

 <!--datepicker-->
 <link rel="stylesheet" href="{{ URL::to('public/assets/datepicker/bootstrap-datetimepicker.min.css') }}">
