...
class BannerController extends Controller
{
    ...
    public function getdanhsach(Request $request)
    {
        ...
        return view('trangquanly.admin.banner.danhsach', compact('slides'))->with('tendanhsach', 'Danh sách Banner');
    }
    // Thêm banner
    public function getthem()
    {
        $slides = DB::table('slides')->get();
        return view('trangquanly.admin.banner.them', compact('slides'));
    }
